...
echo"<li value='".$my_new_task."' class='mylist'>".$my_new_task."<button class='close' value='".$my_new_task."' onclick='delfunc(this)' >×</button><button class='edit_task' onclick='editfunc(this)' value='".$my_new_task."' >&#9999</button><button class='complete' value='".$my_new_task."' onclick='comfunc(this)'>✓</button></li>";
